...
public class CabServiceImpl implements CabService {
    ...
    public CabServiceImpl(CabRepository cabRepository, CityRepository cityRepository, AnalyticsService analyticsService) {
    ...
    public Cab registerCab(Long cityId) {
        ...
        analyticsService.recordCabStateChange(cab.getCabId(), cab.getState(), city.getCityId(), now);
        return cab;
    }
    ...
    public void updateState(Long cabId, CabState newState) {
        ...
        analyticsService.recordCabStateChange(cab.getCabId(), newState, cityId, now);
    }
